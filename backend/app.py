...
@app.route('/commune/objets_supports/<int:code_insee>')
def get_link_to_support_object(code_insee):
    return jsonify(geometric_matching_controller.link_to_support_object(code_insee))

@app.route('/commune/voie/<int:code_insee>')
def troncon_merged(code_insee):
...
@app.route('/commune/appariement_geometrique/<int:code_insee>')
def geometric_matching(code_insee):
    return jsonify(geometric_matching_controller.geometric_matching(code_insee))
